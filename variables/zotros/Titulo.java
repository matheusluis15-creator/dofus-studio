...
public class Titulo {
	...
	public Titulo(int _id, String _nombre, int _creditos, int _ogrinas, int _kamas, boolean _vender, boolean _valido) {
		this._id = _id;
	...
	public boolean adquirirTitulo(Personaje _perso) {
		if (!_valido) {
			return false;
		}
		if (_perso.tieneTitulo(_id)) {
			return true;
		}
		if (_vender) {
			if (_creditos > 0) {
